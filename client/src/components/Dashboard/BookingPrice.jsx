...
const BookingPrice = ({ bClick, cClick }) => {
  return <>
    <div className='price-container'>
      <div className='booking-navbar'>
        ...
        <div className='navbar-btn-container'>
          <div className='navbar-btn-one' onClick={() => bClick()}>
            <button>
              City Select
              <div className='navbar-btn-one-img'><img src={bookingLocation} alt='img' /></div>
            </button>
          </div>
          <div className='navbar-btn-two' onClick={() => cClick()}>
            <button>
              Go to Cart
      ...
      <div className='back-to-city' onClick={() => bClick()}>
        &lt; Back to City
      </div>
    </div>
  </>
